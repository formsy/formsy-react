(function (global, factory) {
  ...
  */
        ...
        return Promise.all(Object.keys(validations).map(function (validationMethod) {
          ...
          if (typeof validationsVal === 'function') {
            return Promise.resolve(validationsVal(currentValues, value)).then(function (validation) {
              var validationType = _typeof(validation);

              if (validationType === 'string' || validationType === 'object' && validation !== null) {
                results.errors.push(validation); // validation message could be react element/fragment
  ...
  function Wrapper (WrappedComponent) {
    ...
    }, _class.defaultProps = _objectSpread2({
      innerRef: null,
      required: false,
      validationError: '',
      validationErrors: {},
  ...
  function (_React$Component) {
    ...
    function Formsy(props) {
      ...
      _this.submit = function (event) {
        ...
        return onSubmit(model, _this.resetModel, _this.updateInputsWithError, event);
      };
