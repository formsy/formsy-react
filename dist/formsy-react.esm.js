...
var Formsy = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper(Formsy);
  ...
  function Formsy(props) {
      ...
      if (disabled !== prevProps.disabled) {
        ...
        _this.setState(function (state) {
          return _objectSpread2(_objectSpread2({}, state), {}, {
            contextValue: _objectSpread2(_objectSpread2({}, state.contextValue), {}, {
    ...
    _this.mapModel = function (model) {
      ...
      Object.keys(model).forEach(function (key) {
        lodash_set(returnModel, key, model[key]);
      });
      return returnModel;
    };
    ...
    _this.resetModel = function (data) {
      _this.inputs.forEach(function (component) {
        ...
        if (data && lodash_has(data, name)) {
          component.setValue(lodash_get(data, name));
        } else {
...
export { addValidationRule, propTypes$1 as propTypes, validations as validationRules, withFormsy };
