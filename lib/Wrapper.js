...
var propTypes = {
  ...
  validations: _propTypes['default'].oneOfType([_propTypes['default'].object, _propTypes['default'].string]),
      ...
      _createClass(WrappedComponent, [
        ...
        },
        {
          ...
          value: function componentDidUpdate(prevProps) {
            ...
            if (
              !_utils['default'].isSame(this.props.validations, prevProps.validations) ||
