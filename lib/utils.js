    ...
    if (Object.keys(validations).length) {
      Object.keys(validations).forEach(function(validationMethod) {
        if (
          ...
          throw new Error(
            'Formsy does not allow you to override default validations: '.concat(
              validationMethod,
            ),
          );
        }
        ...
        if (
          ...
          throw new Error(
            'Formsy does not have the validation rule: '.concat(
              validationMethod,
            ),
          );
        }
        ...
        if (typeof validations[validationMethod] === 'function') {
          ...
          var _validation = validationRules[validationMethod](
            currentValues,
            value,
